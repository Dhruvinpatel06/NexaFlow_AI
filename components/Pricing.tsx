    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Starter */}
          <div className="p-8 hover:shadow-lg transition-all pricing-card-starter" style={{ background: 'white', border: '1px solid rgba(17,76,90,0.1)', borderRadius: '20px' }}>
          ...
          {/* Pro */}
          <div className="p-8 relative pricing-pro-glow" style={{ background: 'linear-gradient(135deg, var(--dark) 0%, #1a5f73 100%)', border: '1px solid rgba(255,200,1,0.3)', borderRadius: '20px', boxShadow: '0 25px 60px rgba(17,76,90,0.4)', transform: 'scale(1.04)', overflow: 'hidden' }}>
            {/* Top shimmer line */}
            ...
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full text-sm font-bold" style={{ backgroundColor: 'var(--primary)', color: 'var(--surface)', boxShadow: '0 4px 16px rgba(255,200,1,0.4)' }}>
              Most Popular
            </div>
          ...
          {/* Enterprise */}
          <div className="p-8 hover:shadow-lg transition-all pricing-card-enterprise" style={{ background: 'white', border: '1px solid rgba(17,76,90,0.1)', borderRadius: '20px' }}>
